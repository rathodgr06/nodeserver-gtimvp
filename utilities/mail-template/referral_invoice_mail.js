                            ...
                            <tbody>
                                <tr>
                                    <td class="sm-py-32 sm-px-24"
                                        style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 20px 20px 20px 10px; text-align: center;"
                                        align="center">
                                        <a href="javascript:;">
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding: 10px 48px 10px 20px; width: 50%;">
                                                        <p style="margin: 24px 0;">
                                                            <b style="color: #263238 !important;">Referral Code</b>
                                                        </p>
                                                    </td>
                                                    <td
                                                        style="vertical-align: middle; text-align: right; padding-right: 20px;">
                                                        <b
                                                            style="color: #263238 !important; font-size: 16px !important;">${data.referral_code}
                                                           </b>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="sm-px-24"
                                                        ...
                                                        <p style="margin: 24px 0;">
                                                            <b style="color: #263238 !important;">Referrer Name</b>
                                                            <br>${data.referrer_name}
                                                        </p>
                                                        <p style="margin: 24px 0;">
                                                        <b style="color: #263238 !important;">Bonus Earned From Successful Referral</b>
                                                        <br>${data.successful_referral}
                                                    </p>
                                                        <p style="margin: 24px 0;">
                                                        <b style="color: #263238 !important;">Total Tax</b>
                                                        <br>${data.total_tax}
                                                    </p>
                                                    <p style="margin: 24px 0;">
                                                    <b style="color: #263238 !important;">Total Bonus</b>
                                                    <br>${data.total_bonus}
                                                </p>

                                                        <p style="margin: 24px 0;">
                                                            <b style="color: #263238 !important;"> Date</b>
                                                            <br> ${data.payout_date}
                                                        ...
                                                        <b style="color: #263238 !important;"> Description</b></p>
                                                        ${data.message}
                                                ...
                                                <td>
                                                        ...
                                                        <p style="margin: 0.2in" >
                                                            Hi ${data.referrer_name},<br> If you notice any error please
                                                            contact us at <a href="mailto: support@saopayglobal.com">
                                                                support@saopayglobal.com
                                                            </a>

                                                        </p>
                                                        <p style="margin: 0.2in;" >Thanks, <br>${title} Team</p>
