        ...
        if (
          ...
          switch (psp) {
            case "MTN-MOMO":
              ...
              break;
            case "MTN":
              let mtn_sandbox_res = await confirmMTNSandbox(order_id, mode);
              res
                .status(statusCode.ok)
                .send(
                  response.successansmsg(
                    mtn_sandbox_res.data,
                    mtn_sandbox_res.message,
                    "SUCCESS"
                  )
                );
              break;
            ...
            case "Orange":
              ...
              res
                ...
                .send(
                  response.successansmsg(
                    orange_sandbox_res.data,
                    orange_sandbox_res.message,
                    "SUCCESS"
                  )
                );
              break;
...
async function confirmMTNSandbox(order_id, mode) {
  let order_table;
  let generate_request_id_table;
  let order_details;
  let mid_details;
...
async function confirmOrangeSandbox(order_id, mode) {
  let order_table;
  let generate_request_id_table;
  let order_details;
  let mid_details;
  ...
  try {
    ...
    let config = {
      method: "get",
      url: `${url}orange/OM/Transaction/Status`,
      headers: {
        "Content-Type": "application/json",
      },
      httpsAgent: agent,
