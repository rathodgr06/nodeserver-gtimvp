const CountryModel = require("../models/business_register_country");
                ...
                admin_activity_logger
                    ...
                    .then((result) => {
                        res.status(statusCode.ok).send(
                            response.successmsg("Business Reg. country added successfully.")
                        );
                    })
                    .catch((error) => {
                        winston.error(error);
    ...
    update: async (req, res) => {
        try {
            ...
            admin_activity_logger
                ...
                .then((result) => {
                    res.status(statusCode.ok).send(
                        response.successmsg("Business Reg. country updated successfully")
                    );
                })
                .catch((error) => {
                    winston.error(error);
    ...
    country_deactivate: async (req, res) => {
        try {
            ...
            admin_activity_logger
                ...
                .then((result) => {
                    res.status(statusCode.ok).send(
                        response.successmsg("Business Reg. country deactivated successfully")
                    );
                })
                .catch((error) => {
                    winston.error(error);
    ...
    country_activate: async (req, res) => {
        try {
            ...
            admin_activity_logger
                ...
                .then((result) => {
                    res.status(statusCode.ok).send(
                        response.successmsg("Business Reg. country activated successfully")
                    );
                })
                .catch((error) => {
                    winston.error(error);
    ...
    country_delete: async (req, res) => {
        try {
            ...
            admin_activity_logger
                ...
                .then((result) => {
                    res.status(statusCode.ok).send(
                        response.successmsg("Business Reg. country deleted successfully")
                    );
                })
                .catch((error) => {
                    winston.error(error);
